...
const App = memo(() => {
  ...
  const onExportConfirm = useCallback(async () => {
    ...
    try {
      ...
      if (willMerge) {
        ...
        submitFile = await autoConcatCutSegments({
          customOutDir,
          outFormat: fileFormat,
  ...
  }, [working, filePath, duration, cutSegments, createIndexedSegment, setCurrentSegIndex, setCutSegments, onSdobSetSlate]);
