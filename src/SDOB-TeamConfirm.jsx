...
const SdobTeamConfirm = memo(({
  ...
  const updateEvents = useCallback(() => {
    ...
    const apiUrl = new URL(`${baseUrl.pathname}/events/${sdobSelectedEvent}/comps/`, sdobAPIServer).href;

    console.log("Updating", baseUrl)
        ...
        <>
          ...
          >
            <div style={{ margin: 'auto' }}>
              ...
              <div style={boxStyle}>              
                <div className="sdob-team-selection-container">
                  <div>
                  ...
                  <div>
                    <h2 className="sdob-team-selection-item" style={{ marginTop: 0, width: '60vw' }}>Round Number</h2>
                  </div>
                </div>

                <div>
                {sdobTeamList.map(team => (
                  <div key={team.id.toString()} className="sdob-team-selection-container">
                    <div className="sdob-team-selection-item sdob-team-selection-name">{String(team.teamNumber)} {String(team.name)}</div>
                    {sdobRoundList.map(rnd => (
                      <div
                        ...
                        className="sdob-team-selection-item"
