...
const NoFileLoaded = memo(({ topBarHeight, bottomBarHeight, currentCutSeg, onSdobOpenFileClick }) => {
  const { t } = useTranslation();

  return (
    <div className="no-user-select" role="button" style={{ position: 'fixed', left: 0, right: 0, top: topBarHeight, bottom: bottomBarHeight, border: '2vmin dashed #252525', color: '#505050', margin: '5vmin', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', whiteSpace: 'nowrap' }} onClick={onSdobOpenFileClick}>
